...
{
	l0->x = l0->x * mlx->img->zoom + WIDTH / 2 - mlx->img->width / 2;
	l0->y = l0->y * mlx->img->zoom + HEIGHT / 2 - mlx->img->height / 2;
	l1->x = l1->x * mlx->img->zoom + WIDTH / 2 - mlx->img->width / 2;
	l1->y = l1->y * mlx->img->zoom + HEIGHT / 2 - mlx->img->height / 2;
}
